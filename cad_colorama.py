...
for i, csv_file in enumerate(csv_files):
    try:
        draw_dxf(csv_file)
        print(f'{Fore.MAGENTA}[{Fore.WHITE}{i+1}{Fore.MAGENTA}] {Fore.WHITE}{csv_file[:-4]}.dxf {Fore.MAGENTA}file was built successfully')
    except:
        #print(f'[{i+1}] ERROR! an error occurred with {csv_file}')
        print(f'{Fore.MAGENTA}[{Fore.WHITE}{i+1}{Fore.MAGENTA}] ERROR! an error occurred with {Fore.WHITE}{csv_file}')
